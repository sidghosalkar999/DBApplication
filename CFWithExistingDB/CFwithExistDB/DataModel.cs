...
namespace CFwithExistDB
{
    public partial class DataModel : DbContext
    {
        ...
        {
            Database.SetInitializer(new TraderInitializer());

        }

        public class TraderInitializer : DropCreateDatabaseAlways<DataModel>
        {
            protected override void Seed(DataModel context)
            {
                var stu = new STUDENT() { STDNAME = "Siddhesh", STDRESULT = "Fail"};
